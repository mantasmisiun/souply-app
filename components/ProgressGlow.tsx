...
export function ProgressGlow({ fraction, color, edge = 'top' }: { fraction: number; color?: string; edge?: 'top' | 'bottom' }) {
    ...
    return (
        // Bottom edge = flip the whole top-edge treatment vertically (line at the
        // very edge, bloom trailing inward), pinned to the bottom instead.
...
const styles = StyleSheet.create({
    ...
    glowWrapTop: { top: 0 },
    glowWrapBottom: { bottom: 0, transform: [{ scaleY: -1 }] },
    glowFill: { height: '100%' },
    glowLine: { height: 3 },
